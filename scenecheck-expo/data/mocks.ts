...
export const SC_EVENTS: SCEvent[] = [
  ...
  { id: 'e4', kind: 'recommended', hostId: null, title: 'Pickup Soccer @ Aldrich', host: 'App-created', interests: ['running', 'uci'], when: 'Wed May 6 · 5:00 PM', endTime: '7:00 PM', where: 'Aldrich Park East Field', attendees: 22, cap: 30, rating: null, x: 0.46, y: 0.55, desc: "Open pickup, 5v5 rotating. Cleats not required. Pulled from the UCI Rec calendar.", sourceUrl: 'https://rec.uci.edu/events/pickup-soccer', image: 'https://picsum.photos/seed/scenecheck-soccer/800/450' },
  { id: 'e5', kind: 'recommended', hostId: null, title: 'Open Mic — Common Room', host: 'App-created', interests: ['music'], when: 'Thu May 7 · 8:00 PM', endTime: '10:30 PM', where: 'Common Room Coffee', attendees: 11, cap: 25, rating: null, x: 0.74, y: 0.50, desc: "Acoustic, poetry, comedy — all welcome. Sign-ups at the door from 7:30.", image: 'https://picsum.photos/seed/scenecheck-openmic/800/450' },
